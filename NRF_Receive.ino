...
int flag = 0;  // if a bluetooth string is received from mobile
  ...
  if (flag == 1) {
    ...
    if (radio.available()) {
     ...
     // lcd.clear();
      ...
      char c = '1'; //here i need to give file number according to receiving logic
      if(distance>0 && distance<=100)c = '1';
      else if(distance>100 && distance<=200)c = '2';
      else if(distance>200 && distance<=300)c = '3';
      else if(distance>300 && distance<=400)c = '4';
      else if(distance>400 && distance<=500)c = '5';
      else if(distance>500 && distance<=600)c = '6';
      else if(distance>600 && distance<=700)c = '7';
      else if(distance>700 && distance<=800)c = '8';
      else if(distance>800 && distance<=900)c = '9';
